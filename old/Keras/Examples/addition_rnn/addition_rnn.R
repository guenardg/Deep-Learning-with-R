...
## Padding is handled by using a repeated sentinel character (space) Input may optionally be
## reversed, shown to increase performance in many tasks in: “Learning to Execute”
## http://arxiv.org/abs/1410.4615 and “Sequence to Sequence Learning with Neural Networks”
...
## str(examples)
## head(examples$questions) ; head(examples$results)
##
## Vectorization
